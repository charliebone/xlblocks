...
internal static class DataTypes_List
{
    ...
    [ExcelFunction(Description = "Return the size of a list", IsThreadSafe = true)]
    ...
    [ExcelFunction(Description = "Return the size of a list as a string", IsThreadSafe = true)]
    ...
    [return: CacheContents]
    [ExcelFunction(Description = "Return the subset of unique items in the list", IsThreadSafe = true)]
    ...
    [return: CacheContents]
    [ExcelFunction(Description = "Return the subset of duplicate items in the list", IsThreadSafe = true)]
    ...
    [return: CacheContents]
    [ExcelFunction(Description = "Merge multiple lists into one, tossing duplicate values", IsThreadSafe = true)]
    ...
    [return: CacheContents]
    [ExcelFunction(Description = "Make a list containing intersection (shared items) of input lists", IsThreadSafe = true)]
